...
export const CardsComponent = (props) => {
    ...
    // const [isFavorite, setIsFavorite] = useState(props.product.favorite);
    ...
    const favHandler = () => {
        props.setTatoo(prev => {
            const temp = [...prev];
            temp.forEach(tatoo => {
                if(props.tatoo.id === tatoo.id) {
                    tatoo.favorite = !tatoo.favorite
                }
    ...
    return (
        <div className="cards-post">
            <div className={props.tatoo.favorite ? "favorite plus" : "favorite"} onClick={favHandler}>
